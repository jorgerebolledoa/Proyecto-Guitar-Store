        ...
        <div className="col-lg-12 mb-4">
          <div className="card shadow mb-4 bg-dark text-white">
            <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-white">Tareas Pendientes</h6>
            </div>
            <div className="card-body">
              <h4 className="small font-weight-bold">
                Actualización de stock <span className="float-right">20%</span>
              </h4>
              ...
              <h4 className="small font-weight-bold">
                Revisar base de datos de usuarios <span className="float-right">60%</span>
              </h4>
              <div className="progress mb-4">
                <div
                  className="progress-bar bg-warning"
              ...
              <h4 className="small font-weight-bold">
                Capacitación empleados <span className="float-right">Complete!</span>
              </h4>
